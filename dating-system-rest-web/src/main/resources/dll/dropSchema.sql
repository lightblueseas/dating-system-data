...
alter table favorite_members drop constraint FK_FAVORITE_MEMBERS_FAVORITE_ID;
alter table favorite_members drop constraint FK_FAVORITE_MEMBERS_OWNER_ID;
alter table federalstates drop constraint FK_FEDERAL_STATES_COUNTRY_ID;
alter table friendship_requests drop constraint FK_FRIENDSHIPREQUESTS_REQUESTOR_ID;
alter table friendship_requests drop constraint FK_FRIENDSHIPREQUESTS_R_USER_ID;
...
alter table profile_notice drop constraint FKCED38A2EAD316C13;
alter table profile_notice drop constraint FK_PROFILE_NOTICE_USER_ID;
alter table profile_ratings drop constraint FKC752F9E0C2D006CC;
alter table profile_ratings drop constraint FKC752F9E0B117ECD;
alter table profile_visitors drop constraint FK_PROFILE_VISITORS_VISITOR_ID;
alter table profile_visitors drop constraint FK6810CF9BFDFAE472;
...
alter table user_profile drop constraint FK_PROFILE_IMAGE_ID;
alter table user_profile drop constraint FK487E213538F1F9BD;
